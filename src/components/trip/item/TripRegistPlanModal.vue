            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="max-height: 80vh;">
                    ...
                    <div class="overflow-auto" style="max-height: calc(80vh - 130px);"> <!-- 최대 높이를 계산하여 지정 -->
                        <div v-for="attraction in attractionList" :key="attraction.contentId" data-bs-dismiss="modal" aria-label="Close" @click="addAttraction(index, attraction)">{{ attraction.title }}</div>
                    </div>
                </div>
            </div>
        </div>
